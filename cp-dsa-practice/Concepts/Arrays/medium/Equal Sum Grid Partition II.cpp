...
// Space Complexity: O(m*n) in the worst case for the hash maps storing the frequency of elements in the partitions. In practice, it may be less depending on the number of unique elements in the grid.
//day 27 of 100 DSA day challenge
