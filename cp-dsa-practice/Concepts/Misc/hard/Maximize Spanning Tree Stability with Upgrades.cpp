...
// DS Used: Disjoint Set Union (DSU)
// Time Complexity: O(E log E) where E is the number of edges, due to sorting the flexible edges
// Space Complexity: O(V) where V is the number of vertices, due to the DSU data structures
