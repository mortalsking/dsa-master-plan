...
// Time Complexity: O(n*m) where n and m are the dimensions of the coins grid. We fill a 3D DP table of size n*m*3.
// Space Complexity: O(n*m*3) for the DP table.
//day 34 of 100 day challenge
#include <bits/stdc++.h>
using namespace std;
